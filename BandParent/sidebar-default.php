...
<?php theme_wrapper($style, array('title' => __('Archives', THEME_NS), 'heading' => $heading, 'content' => ob_get_clean())); ?>

<?php ob_start();?>
      <ul>
        <?php wp_list_bookmarks('orderby=rating&title_li=&categorize=0'); ?>
      </ul>
<?php theme_wrapper($style, array('title' => __('Bookmarks', THEME_NS), 'heading' => $heading, 'content' => ob_get_clean())); ?>
